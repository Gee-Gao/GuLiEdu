      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section id="videoPlay" class="p-h-video-box">
            <img :src="course.cover" :alt="course.title" class="dis c-v-pic" style="width:640px; height: 357px">
          </section>
        </article>
  ...
  methods: {
    initCourseInfo() {
      courseApi.getCourseInfo(this.courseId).then(response => {
        ...
        this.teacherId=response.data.data.course.teacherId;
    ...
    createOrder() {
      orders.createOrder(this.courseId).then(response => {
