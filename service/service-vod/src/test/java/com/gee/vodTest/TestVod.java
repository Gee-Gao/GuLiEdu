...
public class TestVod {
    ...
    public void testUploadVideo(){
        ...
        //文件名必须包含扩展名
        String fileName = "C:\\Users\\Gee\\Desktop\\1.mp4";
        //本地文件上传
        UploadVideoRequest request = new UploadVideoRequest("LTAI4G5Zf81jhYfrfZpzpfx2", "ukjsTIBpxy2WYlNxVtAhRct2SmJcNV", title, fileName);
